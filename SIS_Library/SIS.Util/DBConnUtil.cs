...
using SIS_Library.SIS.Exception;
using SIS_Library.SIS.Main;
...
namespace SIS_Library.SIS.Util
{
    ...
    { 
            private static string connectionString = "Server=.\\sqlexpress;Database=SISDB;Trusted_Connection=True;TrustServerCertificate=True";
